// "Other Skills & Tools" category data for the Resume page.
export const skillGroups = [
  { label: 'Programming Languages', icon: 'ri-code-s-slash-line', items: ['Dart', 'Java', 'Kotlin', 'Swift', 'JavaScript', 'TypeScript', 'PHP', 'Python'] },
  { label: 'Frameworks & Technologies', icon: 'ri-stack-line', items: ['Flutter', 'Electron', 'Node.js', 'Nest.js', 'Express', 'Next.js', 'FlutterFlow', 'Expo', 'React Native', 'Astro'] },
  ...
  { label: 'IDEs & Dev Tools', icon: 'ri-terminal-box-line', items: ['Android Studio', 'Xcode', 'Cursor', 'Visual Studio Code', 'Postman', 'Unity 3D'] },
];
