...
src/
  ...
  data/
    projects.js           # Canonical 6-category/19-project list (slug, mark, name, metric, challenge,
...
- NebuFit, Creative OS, Houzi, Orient Champions, UNITY, Linked Golf: safe to feature in full detail (UNITY cleared 2026-08-09 — client described generically as "a healthcare organisation", no specific company name; Linked Golf was never confidential, just not yet split out with its own screenshots/case-study link on About)
