...
```
src/
  components/     # HcNav, HcFooter — used by Home/Work/Services/Resume/Contact (hc- design system)
  ...
  styles/         # global.css — legacy CSS variables, reset, shared utility classes
                  # hc-shared.css — shared "hc-" Graflow-style design system (Home + Work + Services + Resume + Contact)
public/
  assets/
    gifs/           # Static GIFs
